...
**pawfal**: 
- www.pawfal.org
- http://www.pawfal.org/Software/
**김종민**: blog.cmiscm.com
**minjang**: minjang.github.io
**소년코딩**: boycoding.tistory.com
**gameprogramming**: gameprogrammingpatterns.com
**khalilstemmler**: khalilstemmler.com
**webdir**: webdir.tistory.com
**개발자스럽다**: blog.gaerae.com
**beautifulseams**: www.beautifulseams.com
**cactus**: cactus.tistory.com
**snwh**: snwh.org
...
**kvm passthrough**: www.nepirity.com/blog/kvm-gpu-passthrough/
**calamares**: calamares.io
**XCB**
**XDG**
**Curses**: www.google.com/search?q=Curses
**Linux screen**: linuxize.com/post/how-to-use-linux-screen/
**linuxbbq**: linuxbbq.com
**dunst**: dunst-project.org
## Arch Linux
**arch wiki**: wiki.archlinux.org
**make archlinux installer**: www.google.com/search?q=make+own+arch+linux+installer
**aui**: github.com/helmuthdu/aui
**krushn**: github.com/krushndayshmookh/krushn-arch
**alis**: github.com/picodotdev/alis
**anarchy**: gitlab.com/anarchyinstaller/installer
**Archiso**: wiki.archlinux.org/index.php/Archiso
## GUI Customizing
**unixporn**: 
...
### Sunvox
**official**: www.warmplace.ru/soft/sunvox/
